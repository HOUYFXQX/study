...
public class Xssf2Hssf {
    ...
    public HSSFWorkbook transformXSSF(XSSFWorkbook workbookOld) {
        ...
        for (int i = 0; i < workbookOld.getNumberOfSheets(); i++) {
            this.transform(workbookOld, workbookNew, workbookOld.getSheetAt(i), workbookNew.createSheet(workbookOld.getSheetAt(i).getSheetName()));
        }
        return workbookNew;
    }
