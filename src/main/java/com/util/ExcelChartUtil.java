...
//            Xssf2Hssf xssf2Hssf=new Xssf2Hssf();
//            HSSFWorkbook hs= xssf2Hssf.transformXSSF(wb);
            //导出到文件
            FileOutputStream out = new FileOutputStream(new File("E:/jcdemo/" + System.currentTimeMillis() + ".xlsx"));
//            hs.write(out);
            wb.write(out);
            out.close();
        } catch (Exception e) {
     ...
     * @return
     */
    private boolean drawSheet0Map(XSSFSheet sheet, Enum group, List<String> fldNameArr,
     ...
     * @return
     */
    private boolean drawSheet2Map(XSSFSheet sheet, String type, List<String> fldNameArr,
                                  List<Map<String, Object>> dataList, List<String> titleArr) {
        boolean result = false;
        // 获取sheet名称
        String sheetName = sheet.getSheetName();
     ...
     * @return 是否生成成功
     */
    private boolean drawSheet0Table(XSSFSheet sheet, List<String> titleArr, List<String> fldNameArr,
                                    List<Map<String, Object>> dataList) {
        // 测试时返回值
        boolean result = true;
        // 初始化表格样式
